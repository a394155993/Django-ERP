...
class Module(generic.BO):
    ...
    parent = models.ForeignKey('self', blank=True, null=True, verbose_name=_("parent"), on_delete=True)
...
class Menu(generic.BO):
    ...
    """
    index_weight = 3
    module = models.ForeignKey(Module, verbose_name=_("module"), on_delete=True)
