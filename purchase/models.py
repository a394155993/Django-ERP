...
class POItem(models.Model):
    ...
    """
    index_weight = 2
    po = models.ForeignKey(PurchaseOrder, verbose_name=_("purchase order"), on_delete=True)
    material = models.ForeignKey(Material, verbose_name=_("material"), limit_choices_to={"is_virtual": "0"}, on_delete=True)
    ...
    tax = models.CharField(_("tax rate"), max_length=const.DB_CHAR_CODE_6, choices=const.get_value_list('S052'),
                           default='0.00')
    woitem = models.ForeignKey(WOItem, verbose_name=_("wo item"), blank=True, null=True, on_delete=True)
