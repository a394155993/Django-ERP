...
class ValueList(generic.BO):
    ...
    module = models.ForeignKey(Module, verbose_name=_("module"), blank=True, null=True, on_delete=True)
    ...
    locked_by = models.ForeignKey(User, verbose_name=_("locked by"), blank=True, null=True, on_delete=True)
...
class ValueListItem(models.Model):
    ...
    值列表项
    """
    group = models.ForeignKey(ValueList, verbose_name=_("list group"), on_delete=True)
...
class Partner(generic.BO):
    ...
    org = models.ForeignKey(Organization, verbose_name=_("organization"), blank=True, null=True, on_delete=True)
...
class BankAccount(generic.BO):
    ...
    partner = models.ForeignKey(Partner, verbose_name=_("partner"), blank=True, null=True, on_delete=True)
    org = models.ForeignKey(Organization, verbose_name=_("organization"), blank=True, null=True, on_delete=True)
...
class Project(generic.BO):
    ...
    partner = models.ForeignKey(Partner, blank=True, null=True, verbose_name=_("partner"),
                                limit_choices_to={"partner_type": "C"}, on_delete=True)
...
class Trade(models.Model):
    ...
    parent = models.ForeignKey('self', verbose_name=_("parent"), null=True, blank=True, on_delete=True)
...
class Brand(models.Model):
    ...
    """
    index_weight = 101
    trade = models.ForeignKey(Trade, verbose_name=_("trade"), null=True, blank=True, on_delete=True)
    name = models.CharField(_("name"), max_length=const.DB_CHAR_NAME_120)
    pinyin = models.CharField(_("pinyin"), max_length=const.DB_CHAR_NAME_120, blank=True, null=True)
...
class TechnicalParameterName(models.Model):
    ...
    """
    index_weight = 7
    category = models.ForeignKey(Category, verbose_name=_("material category"), on_delete=True)
    name = models.CharField(_("name"), max_length=const.DB_CHAR_NAME_40)
    status = models.BooleanField(_("in use"), default=True)
...
class TechnicalParameterValue(models.Model):
    ...
    """
    tech_name = models.ForeignKey(TechnicalParameterName, verbose_name=_("technical name"), on_delete=True)
...
class Material(generic.BO):
    ...
    pinyin = models.CharField(_("pinyin"), max_length=const.DB_CHAR_NAME_120, blank=True, null=True)
    brand = models.ForeignKey(Brand, blank=True, null=True, verbose_name=_("brand"), on_delete=True)
    category = models.ForeignKey(Category, blank=True, null=True, verbose_name=_("category"), on_delete=True)
    ...
    warehouse = models.ForeignKey(Warehouse, blank=True, null=True, verbose_name=_("warehouse"), on_delete=True)
...
class MaterialParam(models.Model):
    ...
    """
    material = models.ForeignKey(Material, on_delete=True)
    param_value = models.ForeignKey(TechnicalParameterValue, on_delete=True)
    param_name = models.ForeignKey(TechnicalParameterName, blank=Trade, null=True, on_delete=True)
...
class ExtraParam(models.Model):
    ...
    material = models.ForeignKey(Material, verbose_name=_("material"), on_delete=True)
    name = models.CharField(_("name"), max_length=const.DB_CHAR_NAME_40)
...
class Employee(generic.BO):
    ...
    phone = models.CharField(_("phone"), max_length=const.DB_CHAR_NAME_20, blank=True, null=True)
    organization = models.ForeignKey(Organization, verbose_name=_('organization'), null=True, blank=True, on_delete=True)
    ...
    position = models.ForeignKey(Position, verbose_name=_('position'), on_delete=True)
    ...
    user = models.ForeignKey(User, verbose_name=_("user"), blank=True, null=True, on_delete=True)
...
class Family(generic.BO):
    ...
    employee = models.ForeignKey(Employee, verbose_name=_("employee"), on_delete=True)
...
class DataImport(generic.BO):
    ...
    content_type = models.ForeignKey(ContentType, verbose_name=_("content type"),
                                     limit_choices_to={"app_label__in": ['basedata', 'organ', 'auth']}, on_delete=True)
