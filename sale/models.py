...
class SaleOrder(generic.BO):
    ...
    partner = models.ForeignKey(Partner, verbose_name=_("partner"), limit_choices_to={"partner_type": "C"}, on_delete=True)
    ...
    discount_amount = models.DecimalField(_("discount amount"), max_digits=12, decimal_places=2, blank=True, null=True,
                                          default=0.00)
    user = models.ForeignKey(User, verbose_name=_("sales man"), blank=True, null=True, on_delete=True)
...
class SaleItem(models.Model):
    ...
    订单明细
    """
    master = models.ForeignKey(SaleOrder, on_delete=True)
    material = models.ForeignKey(Material, verbose_name=_("material"),
                                 limit_choices_to={"is_virtual": "0", 'can_sale': '1'}, blank=True, null=True, on_delete=True)
...
class PaymentCollection(generic.BO):
    ...
    so = models.ForeignKey(SaleOrder, verbose_name=_("sale order"), on_delete=True)
    ...
    bank = models.ForeignKey(BankAccount, verbose_name=_("bank account"), blank=True, null=True, on_delete=True)
...
class OfferSheet(generic.BO):
    ...
    discount_amount = models.DecimalField(_("discount amount"), max_digits=12, decimal_places=2, blank=True, null=True,
                                          default=0.00)
    user = models.ForeignKey(User, verbose_name=_("offer man"), blank=True, null=True, on_delete=True)
...
class OfferItem(models.Model):
    ...
    订单明细
    """
    master = models.ForeignKey(OfferSheet, on_delete=True)
    material = models.ForeignKey(Material, verbose_name=_("material"),
                                 limit_choices_to={"is_virtual": "0", 'can_sale': '1'}, blank=True, null=True, on_delete=True)
    measure = models.ForeignKey(Measure, verbose_name=_("measure"), blank=True, null=True, on_delete=True)
    cnt = models.DecimalField(_("count"), max_digits=14, decimal_places=4)
