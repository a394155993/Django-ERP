...
class Entry(generic.BO):
    ...
    guider = models.ForeignKey(Employee, verbose_name=_("guider"), on_delete=True)
    position = models.ForeignKey(Position, verbose_name=_('designate position'), on_delete=True)
...
class EmployeeSalaryItem(models.Model):
    ...
    """
    entry = models.ForeignKey(Entry, verbose_name=_("employee entry"),on_delete=True)
    employee = models.ForeignKey(Employee, verbose_name=_("employee"), blank=True, null=True, on_delete=True)
    salary_item = models.ForeignKey(SalaryItem, verbose_name=_("salary item"), on_delete=True)
